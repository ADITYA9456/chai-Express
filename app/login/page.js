...
const Login = () => {
    ...
    return (<>
        <div className="flex flex-col items-center ">
            ...
            <div className=" text-center  text-white text-xl font-bold p-6" > Login page for fans </div>

            <div className="form flex flex-col py-2 ">
                <input type="text" placeholder="Email" className="bg-gray-100 p-2 rounded-lg mb-2" />
                <input type="password" placeholder="Password" className="bg-gray-100 p-2 rounded-lg mb-2" />
            </div>
            <div className="flex flex-col m-6">
                ...
                <div className="italic underline text-center text-blue-900">
